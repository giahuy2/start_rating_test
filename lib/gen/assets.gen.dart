...
class $AssetsAudiosGen {
  ...
  /// File path: assets/audios/success_sound.mp3
  String get successSound => 'assets/audios/success_sound.mp3';

  /// List of all assets
  List<String> get values => [successSound];
}

class $AssetsPngGen {
  const $AssetsPngGen();

  /// File path: assets/png/demo_account.webp
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/rating_login.svg
  SvgGenImage get ratingLogin =>
      const SvgGenImage('assets/svg/rating_login.svg');

  /// List of all assets
  List<SvgGenImage> get values => [ratingLogin];
}
